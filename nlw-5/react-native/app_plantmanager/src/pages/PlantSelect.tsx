...
import { PlantCardPrimart } from "../components/PlantCardPrimart";
...
export function PlantSelect() {
  ...
  //O fetchPlants fora do useEffects evita muitos gets por parte do cliente

  useEffect(() => {
    fetchPlants();
  }, []);

  //inicialmente ele retorna o loading, quando as plantas sao carregadas, o loading muda para true
    ...
    <View style={styles.container}>
      ...
      <View style={styles.plants}>
        <FlatList
          ...
          renderItem={({ item }) => <PlantCardPrimart 
            data={item}
